...
///
/// Shows "Press 'h' to reveal a hint" when none revealed,
/// then numbered hints up to `revealed` count.
pub fn render(frame: &mut Frame, area: Rect, hints: &[String], revealed: usize) {
